...
$('.clayPanel').on('mouseover', '.thumb', function(e){ // When a thumb is clicked on
...
////funtion that uses javascript .css method to change css order property for flex items
$(function() { 
$('.row1').on('mousedown', (function() {
  $(this).css({ 'order' : '1'});
  $('.row2').css({ 'order' : '2'});
  $('.row3').css({ 'order' : '3'});
  $('.row4').css({ 'order' : '4'});
